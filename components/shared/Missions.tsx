	...
	return (
		<div className="bg-[#ffe8e8]">
			...
			<section className="absolute hidden xl:flex right-0 -top-[200px]">
				<div className="relative mb-4 2xl:w-[700px] 2xl:h-[500px] aspect-[19/6] object-contain xl:w-[600px] xl:h-[500px] w-[600px] h-[300px] overflow-hidden">
					<Image
					...
					<Image
						...
						width={2050}
						height={470}
						className="absolute -left-[740px] top-[250px] max-w-[228%] opacity-70 rotate-90"
					/>
					<Image
						src={"/svg/LongFlower.svg"}
						alt=""
						width={2050}
						height={470}
						className="absolute -bottom-10 left-0 max-w-[293%] opacity-70"
					/>
				</div>
			</section>
		</div>
