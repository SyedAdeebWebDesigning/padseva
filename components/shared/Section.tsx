...
const Section = ({}: SectionProps) => {
	return (
		<div className="w-full bg-[#e3e1d2]">
			<div className="mx-auto  grid w-full lg:grid-cols-2 grid-cols-1 lg:h-screen">
				{/* Right Image Section */}
				<div className="h-full flex items-center justify-center p-4 lg:pr-40 order-1 lg:order-2 bg-[#eeece2]">
				...
				<div className="flex flex-col justify-center items-start p-10 order-2 lg:order-1 lg:pl-40">
					<h1 className="title-font text-3xl lg:text-5xl mb-4 font-semibold text-[#314030]">
						About PadSeva
					</h1>
